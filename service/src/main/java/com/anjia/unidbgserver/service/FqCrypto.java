...
public class FqCrypto {
     ...
     */
    public static String getRealKey(String registerkeyResponseKey, String registrationKey) throws Exception {
        String fullKeyHex = decryptRegisterKey(registerkeyResponseKey, registrationKey);
    ...
    public static String saveDecryptedContent(String content, String outputDir, String filename) {
        try {
            ...
            log.info("解密内容已保存，文件名: {}", filePath.getFileName());
